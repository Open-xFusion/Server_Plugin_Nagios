...
class ParseDeviceXml:
    ...
    def parseDeviceXml(cls, configPath, configs):
        ...
        for node in Common.getChild(root):
            ...
            config.setVendorId(node.attrib.get("vendorId"))
    ...
    def __parseOidNode(cls, node, nodes):
        ...
        for element in elements:
            ...
            node.setReplace(
                cls.__convertStrToDict(element.attrib.get("replace")))
            nodes.append(node)
        return True
